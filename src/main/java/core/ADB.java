...
public class ADB {
    ...
    public static String command(String command) {
        ...
        else throw new RuntimeException("This method is design to run ADB commands only!");
    ...
    public void moveFile(String sorce, String target) {
        command("adb -s " + ID + " shell mv " + sorce + " " + target);
    }

    public void takeScreenshoot(String target) {
